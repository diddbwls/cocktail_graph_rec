...
- "mint와 lime을 사용하는 칵테일들"
- 재료 → 칵테일 → 공통재료 → 새로운 칵테일 탐색
- "이 재료들로 뭘 만들 수 있나요?"
- 재료 조합 기반 발견적 검색
- 레시피 상세 정보와 함께 재료 네트워크 확장

**C4: 칵테일 유사도 및 대안 추천**
- **특정 칵테일 이름이 타겟으로 명시된** 질문
- "Manhattan과 유사한", "Mojito 같은 스타일"
...
**C4 예시:**
- "Manhattan과 유사한 칵테일 추천해줘" → C4 (타겟=Manhattan 명시)
- "Mojito 같은 스타일의 다른 칵테일들" → C4 (타겟=Mojito 기준)
- "Old Fashioned 대신 마실만한 칵테일" → C4 (타겟=Old Fashioned 대안)
